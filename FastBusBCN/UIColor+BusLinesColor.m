...
{
    return [UIColor colorWithRed:(1.0/255.0)*220.0 green:(1.0/255.0)*50.0 blue:(1.0/255.0)*45.0 alpha:1.0];
}

+ (UIColor *)baixBusLineColor
{
    return [UIColor colorWithRed:(1.0/255.0)*250.0 green:(1.0/255.0)*182.0 blue:(1.0/255.0)*20.0 alpha:1.0];
}

+ (UIColor *)nitBusLineColor
{
    return [UIColor colorWithRed:(1.0/255.0)*0.0 green:(1.0/255.0)*90.0 blue:(1.0/255.0)*195.0 alpha:1.0];
}
...
{
    return [UIColor colorWithRed:(1.0/255.0)*115.0 green:(1.0/255.0)*180.0 blue:(1.0/255.0)*50.0 alpha:1.0];
}

+ (UIColor *)hBusLineColor
{
    return [UIColor colorWithRed:(1.0/255.0)*20.0 green:(1.0/255.0)*70.0 blue:(1.0/255.0)*145.0 alpha:1.0];
}

+ (UIColor *)dBusLineColor
{
    return [UIColor colorWithRed:(1.0/255.0)*154.0 green:(1.0/255.0)*35.0 blue:(1.0/255.0)*135.0 alpha:1.0];
}
